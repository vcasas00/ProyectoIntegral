...
/**
 * 
 * @author René, Vicent, Joaquín Creacion clase VentanaRegistro.
 */
public class VentanaRegistro extends JFrame {
	...
	/**
	 * Creación de la ventana VentanaRegistro, donde se abre un formulario de
	 * registro.
	 */
	public VentanaRegistro() {
		...
		/**
		 * Creación del botón registrarse, una vez llenos los campos de Usuario y
		 * contraseña, clic y estarías registrado.
		 */
			...
			public void actionPerformed(ActionEvent arg0) {
				...
				try {
					...
					if (!u.existeUsuario(nombre)) {
						...
						if (u.usuarioValido(nombre)) {

							if (u.contraseñaValida(contraseña)) {
								...
								JOptionPane.showMessageDialog(contentPane,
										"Contraseña no valida. Recuerda que la contraseña debe tener como minimo: 8 Caracteres, 1 Mayuscula, 1 Minuscula y 1 Numero.");
							}
		...
		/**
		 * Creación del botón VolverAlLogin, para poder volver al login sin tener que
		 * cerrar la app.
		 */
